        ...
        if(this.state.dataLoaded && this.state.societeLoaded){
            return (
                <div style={{display:"grid",gridTemplateColumns:"1fr 6fr 1fr",gridTemplateRows:"auto auto 1fr",gridGap:"16px"}}>
                    <Header style={{placeSelf:"center",gridColumnEnd:"span 3"}} as="h1">Tableaud de bord : {this.state.dashboardsRaw.filter(d=>d.societe._id == this.props.societeFilter)[0].societe.name}</Header>
