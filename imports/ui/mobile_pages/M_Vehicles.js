...
import M_VehiclesRow from '../mobile_molecules/M_VehiclesRow';
...
export class Vehicles extends Component {
        ...
        vehicles : () => {
            if(!this.state.loading){
                ...
                return displayed.map(i =>(
                    <M_VehiclesRow loadVehicles={this.loadVehicles} societesRaw={this.state.societesRaw} key={i._id} vehicle={i} full={this.state.fullLoaded}/>
                ))
            }
        },
        addVehicleQuery : gql`
    ...
    render() {
        return (
            <Fragment>
                <div style={{height:"100%",padding:"8px",display:"grid",gridGap:"16px",gridTemplateRows:"auto auto auto auto 1fr auto",gridTemplateColumns:"1fr"}}>
                    ...
                    <CustomFilterSegment resetAll={this.resetAll} style={{placeSelf:"stretch"}} fullLoaded={this.state.fullLoaded} entryLoaded={this.state.filteredEntry} entryLoadedText={"véhicules"}>
