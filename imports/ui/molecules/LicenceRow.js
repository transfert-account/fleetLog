...
class LicenceRow extends Component {
    ...
    state={
        ...
        editLicenceQuery : gql`
            mutation editLicence($_id:String!,$societe:String!,$number:String!,$vehicle:String!,$shiftName:String!){
                editLicence(_id:$_id,societe:$societe,number:$number,vehicle:$vehicle,shiftName:$shiftName)
            }
        `,
    }
        ...
        if(this.state.editing){
            return (
                <Table.Row>
                    ...
                    <Table.Cell textAlign="center"><Input defaultValue="" value={this.state.newShiftName} onChange={this.handleChange} placeholder="Nom de tournée" name="newShiftName"/></Table.Cell>
